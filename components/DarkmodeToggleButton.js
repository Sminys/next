        ...
        <>
            <button
                className="inline-flex items-center
                    ...
                    focus:outline-none
                    hover:bg-yellow-300 hover:text-orange-500
                ...
                {/*화이트모드*/}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="visible dark:h-0  dark:w-0 h-5 w-5">
