    ...
    return(
        <>
                <div
                    ...
                    <h4 className="title-font sm:text-4xl text-2xl mb-4 font-medium text-gray-900">
                    ...
                    <p className="mb-8 leading-relaxed text-xl">저는 UI/UX 디자이너와 Front-End의 분야에 희망하는 정성민이라고 합니다.
